...
<li>Note: if you appear in this list and A) you'd prefer not to be or B) would prefer a different URL be linked, I hope you will [say as much](mailto:peter@pingpractice.org). Of course, if you do not appear and were present for a call, I hope you will be in touch about this too.</li><br>
            </ol>
          </footer>
