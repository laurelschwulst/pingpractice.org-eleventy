...
Put another way: What might inspire us to publish Pings in ways that…?
Feel aligned with the open posture we receive them in
Encourage the revisiting and reflection Ping Practice is meant to facilitate
Support the meaning-making , connection, and collaboration that we’ve seen emerge in conversations with people who are also pinging
...
- - - 
With all of the above in mind, linked below are a few examples that demonstrate a format Joanne Lam and I have been experimenting with. So far, it's felt like setp that is directionally aligned with the reflection-oriented publishing seeing what other people are pinging might depend on.

→ https://joannelam.com/inpractice/ 
